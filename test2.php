...
<body>
        ...
        <header>
                ...
                <nav>
                    ...
                    <a href="login.php" onclick="" class="login"><i class="fa fa-sign-in" aria-hidden="true"> Se connecter</i></a>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="https://support.content.office.net/en-us/media/f1c4b693-4670-4e7a-8102-bbf1749e83fe.jpg" class="d-block w-100" alt="..." height="596px">
      <div class="carousel-caption d-none d-md-block">
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="next">
    ...
    <div class="side">
        <div class="tabs">
            <h2 class="active tchai">Microsoft Business</h2>
            <h2 class="tchai">Microsoft Entreprise</h2>
            <h2 class="tchai">Services</h2>
        </div>
    
        <div class="tab-side">
             <!-- div containing Ms pack -->
             <div id="toggle" class="active">
                <button class="licence" id="button1" data-price="6.00">
                    <h1 class="nomLicence">Microsoft 365 Business Basics</h1>
                    <h3 class="slogan">Web and mobile apps and services</h3>
                </button>
        
                <button class="licence" id="button2" data-price="12.25">
                    <h1 class="nomLicence">Microsoft 365 Business Standard</h1>
                    <h3 class="slogan">Desktop, web and mobile apps and services</h3>
                </button>
        
                <button class="licence" id="button3" data-price="22.00">
                    <h1 class="nomLicence">Microsoft 365 Business Premium</h1>
                    <h3 class="slogan">Desktop, web and mobile apps  and services</h3>
                </button>
        
                <button class="licence" id="button4" data-price="8.25">
                    <h1 class="nomLicence">Microsoft 365 Apps for Business</h1>
                    <h3 class="slogan">Desktop, web and mobile apps and services</h3>
                </button>
            </div>
            ...
            <div id="toggl">
                <button class="licence" id="button5" data-price="36.00">
                    <h1 class="nomLicence">Microsoft 365 E3</h1>
                    <h3 class="slogan">Web and mobile apps and services</h3>
                </button>
        
                <button class="licence" id="button6" data-price="38.00">
                    <h1 class="nomLicence">Microsoft 365 E5</h1>
                    <h3 class="slogan">Desktop, web and mobile apps and services</h3>
                </button>
        
                <button class="licence" id="button7" data-price="10.00">
                    <h1 class="nomLicence">Microsoft 365 E1</h1>
                    <h3 class="slogan">Desktop, web and mobile apps  and services</h3>
                </button>
        
                <button class="licence" id="button8" data-price="8.00">
                    <h1 class="nomLicence">Microsoft 365 F3</h1>
                    <h3 class="slogan">Desktop, web and mobile apps and services</h3>
                </button>
            </div>
...
<div id="selected-buttons" class="selected"></div>
    ...
    <div class="cout">
        ...
        <p class="to">Total =</p>
            <a href="devis.php"  class="estime"><i class="fa fa-print" aria-hidden="true" class="icon"> Tirez votre devis ici</i></a><br>
            <a href="historique.html"  class="estime"><i class="fa fa-save" aria-hidden="true" class="icon"> Enregistrer</i></a>
    </div>
</div>
